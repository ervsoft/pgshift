...
|----------|----------|------|
| macOS (Intel/Apple Silicon) | [PGShift_0.1.0_x64.dmg](https://github.com/yourusername/sqlequalizer/releases/download/v0.1.0/PGShift_0.1.0_x64.dmg) | ~5.6 MB |
| Windows x64 | [PGShift_0.1.0_x64-setup.exe](https://github.com/yourusername/sqlequalizer/releases/download/v0.1.0/PGShift_0.1.0_x64-setup.exe) | ~8 MB |
