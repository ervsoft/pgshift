-- Migration UP Script
-- Generated at: 2026-02-03T10:51:15.368655+00:00
-- This script applies the schema changes to the target database.

BEGIN;

-- Create enum types (must be before tables)
-- Create enum type 'ApprovalStatus' with values: ["PENDING", "APPROVED", "REJECTED"]
CREATE TYPE "ApprovalStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- Modify enum types
-- Add values to enum 'Role': ["DISTRICT_USER"]
ALTER TYPE "Role" ADD VALUE IF NOT EXISTS 'DISTRICT_USER';
...
CREATE SEQUENCE IF NOT EXISTS "neighborhoods_id_seq";
CREATE TABLE "neighborhoods" (
    "id" SERIAL NOT NULL,
    "name" text NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS "project_logs_id_seq";
CREATE TABLE "project_logs" (
    "id" SERIAL NOT NULL,
    "projectId" integer NOT NULL,
