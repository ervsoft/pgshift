...
if [[ $COMMIT_CHOICE =~ ^[Yy]$ ]]; then
    ...
    if [[ $PUSH_CHOICE =~ ^[Yy]$ ]]; then
        ...
        echo -e "${BLUE}   Check: https://github.com/yourusername/sqlequalizer/actions${NC}"
    fi
fi
...
echo ""
echo "  Release URL: https://github.com/yourusername/sqlequalizer/releases/tag/v$NEW_VERSION"
